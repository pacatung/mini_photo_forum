...
ActiveRecord::Schema.define(version: 20150430025942) do
  ...
  add_index "subscriptions", ["user_id", "photo_id"], name: "index_subscriptions_on_user_id_and_photo_id", unique: true
